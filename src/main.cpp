...
unsigned int nTargetSpacing = 3 * 60; //Block  spacing 3 minute
...
int nCoinbaseMaturity = 25; //Coin Base Maturity
...
const string strMessageMagic = "bitconnectlite Signed Message:\n";
...
int64_t GetProofOfWorkReward(int64_t nFees)
{
            ...
            if(nBestHeight == 2)
            {
            nSubsidy = 4000000 * COIN; //Total premine coin
            }
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "bitconnectlite", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "Bitconnectlite 14.05.2017";
        CTransaction txNew;
        txNew.nTime = 1495005986;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1495005986;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = !fTestNet ? 536623 : 536623;
        ...
        assert(block.hashMerkleRoot == uint256("0x4d194b58ddd31cf896b142935bc1a471d5d8d15fad73f070e7256585b4a9489f"));
